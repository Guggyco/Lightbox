...
public protocol LightboxControllerSendDelegate: class {
    func lightboxController(_ controller: LightboxController, didPressSendButton sendButton: UIButton)
}
...
open class LightboxController: UIViewController {
    ...
    open weak var didSendDelegate: LightboxControllerSendDelegate?
